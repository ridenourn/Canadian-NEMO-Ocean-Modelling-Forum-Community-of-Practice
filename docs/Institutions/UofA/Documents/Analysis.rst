...
`Rotating veocity components from model grid to real lat/lon <../../_static/_UofA/Rotating_U_and_V_components_of_velocity.pdf>`_

`Volume flux calculations on NEMO output <../../_static/_UofA/volume_flux_calculation_NEMO_Aug2015_xhu.pdf>`_ 

`How to calculate eddy kinetic energy (EKE) <../../_static/_UofA/EKE.pdf>`_

`CDFTOOLS usage <../../_static/_UofA/cdftools_usage.pdf>`_
